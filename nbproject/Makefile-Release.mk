...
${OBJECTDIR}/FFTs.o: FFTs.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/FFTs.o FFTs.F90

${OBJECTDIR}/cluster_analysis.o: cluster_analysis.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/cluster_analysis.o cluster_analysis.f90

${OBJECTDIR}/fitting_planes.o: fitting_planes.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/fitting_planes.o fitting_planes.f90

${OBJECTDIR}/functions.o: functions.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/functions.o functions.F90

${OBJECTDIR}/global_variables.o: global_variables.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/global_variables.o global_variables.F90

${OBJECTDIR}/integration_methods.o: integration_methods.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/integration_methods.o integration_methods.F90

${OBJECTDIR}/interpolation_fitting_methods.o: interpolation_fitting_methods.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/interpolation_fitting_methods.o interpolation_fitting_methods.F90
...
${OBJECTDIR}/rheology_routines.o: rheology_routines.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/rheology_routines.o rheology_routines.F90

${OBJECTDIR}/sinal_processing.o: sinal_processing.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/sinal_processing.o sinal_processing.F90

${OBJECTDIR}/statistical_functions.o: statistical_functions.f90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/statistical_functions.o statistical_functions.f90

${OBJECTDIR}/swarm_routines.o: swarm_routines.F90
	${MKDIR} -p ${OBJECTDIR}
	$(COMPILE.f) -O2 -o ${OBJECTDIR}/swarm_routines.o swarm_routines.F90
